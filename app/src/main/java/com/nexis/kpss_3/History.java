...
public class History extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list = triviaQuizHelper.getAllQuestions("Tarih");

        if (list.isEmpty()) {
            Log.e("Tarih", "No questions found in the 'Tarih' category!");
            return;
        }
        ...
        countDownTimer = new CountDownTimer(90000, 1000) {  // 5000 ms toplam süre, 1000 ms arayla tick
            ...
            public void onFinish() {
                ...
                Toast.makeText(History.this, "Süre doldu", Toast.LENGTH_SHORT).show();
    ...
    private void finalResult(){
        ...
        Intent resultIntent = new Intent(History.this, com.nexis.kpss_3.Result.class);
