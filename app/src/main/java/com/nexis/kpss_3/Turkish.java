...
public class Turkish extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list = triviaQuizHelper.getAllQuestions("Türkçe");

        if (list.isEmpty()) {
            Log.e("Türkçe", "No questions found in the 'Türkçe' category!");
            return;
        }
        ...
        countDownTimer = new CountDownTimer(90000, 1000) {  // 5000 ms toplam süre, 1000 ms arayla tick
            ...
            public void onFinish() {
                ...
                Toast.makeText(Turkish.this, "Süre doldu", Toast.LENGTH_SHORT).show();
    ...
    private void finalResult(){
        ...
        Intent resultIntent = new Intent(Turkish.this, com.nexis.kpss_3.Result.class);
        ...
        finish(); // QuizActivity'yi kapat, geri tuşuna basılınca tekrar açılmasın
    }
