...
public class Geography extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list = triviaQuizHelper.getAllQuestions("Coğrafya");

        if (list.isEmpty()) {
            Log.e("Coğrafya", "No questions found in the 'Coğrafya' category!");
            return;
        }
        ...
        countDownTimer = new CountDownTimer(90000, 1000) {  // 5000 ms toplam süre, 1000 ms arayla tick
            ...
            public void onFinish() {
                ...
                Toast.makeText(Geography.this, "Süre doldu", Toast.LENGTH_SHORT).show();
    ...
    private void finalResult(){
        ...
        Intent resultIntent = new Intent(Geography.this,  com.nexis.kpss_3.Result.class);
