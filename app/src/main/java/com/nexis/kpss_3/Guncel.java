...
public class Guncel extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list = triviaQuizHelper.getAllQuestions("Güncel");

        if (list.isEmpty()) {
            Log.e("Güncel", "No questions found in the 'Güncel' category!");
            return;
        }
        ...
        countDownTimer = new CountDownTimer(90000, 1000) {  // 5000 ms toplam süre, 1000 ms arayla tick
            ...
            public void onFinish() {
                ...
                Toast.makeText(Guncel.this, "Süre doldu", Toast.LENGTH_SHORT).show();
    ...
    private void finalResult(){
        ...
        Intent resultIntent = new Intent(Guncel.this,  com.nexis.kpss_3.Result.class);
