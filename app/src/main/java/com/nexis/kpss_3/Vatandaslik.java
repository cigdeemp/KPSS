...
public class Vatandaslik extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list = triviaQuizHelper.getAllQuestions("Vatandaşlık");

        if (list.isEmpty()) {
            Log.e("Vatandaşlık", "No questions found in the 'Vatandaşlık' category!");
            return;
        }
        ...
        countDownTimer = new CountDownTimer(90000, 1000) {  // 5000 ms toplam süre, 1000 ms arayla tick
            ...
            public void onFinish() {
                ...
                Toast.makeText(Vatandaslik.this, "Süre doldu", Toast.LENGTH_SHORT).show();
    ...
    private void finalResult(){
        ...
        Intent resultIntent = new Intent(Vatandaslik.this,  com.nexis.kpss_3.Result.class);
